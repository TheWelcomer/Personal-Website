			...
			<div class="flexreel grid grid-cols-2">
				...
				<div class="cards">
					...
					<div class="super_card super_card_7">
						<div class="card card_7 sticky top-28 min-h-96 mt-4 ml-4 p-4 break-words whitespace-pre-wrap">
							{@html render[7]}
						</div>
					</div>
					<div class="super_card super_card_8">
						<div class="card card_8 sticky top-28 min-h-96 mt-4 ml-4 p-4 break-words whitespace-pre-wrap">
							{@html render[8]}
						</div>
					</div>
				</div>
